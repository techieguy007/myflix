...
const RELEASE_TOKENS = [
  '1080p', '720p', '480p', '2160p', '4k', 'uhd', 'hdr', 'hdr10', 'dv', 'sdr',
  'bluray', 'blu-ray', 'brrip', 'bdrip', 'web-dl', 'webdl', 'webrip', 'hdtv',
...
function removeYear(value) {
  return String(value || '').replace(/\b(19\d{2}|20\d{2})\b/g, ' ').replace(/\s+/g, ' ').trim();
}
